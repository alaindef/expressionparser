...
//        Interpreter.readE(Pass2.parse(Pass1.parse("11.4+2!")))
//        Interpreter.readE(Pass2.parse(Pass1.parse("1.7<2?3.3+4.1:4!")))
//        Interpreter.readE(Pass2.parse(Pass1.parse("2+(12-(3<4 ?3+4:(17-5))!")))
...
//        Pass1.parse("12.3 + 2!")
//        Pass2.parse(Pass1.parse("(-13 aa 2*3)+(5+45)!"))                                    //error
//        Pass2.parse(Pass1.parse("(23 + - rpm)*(-3*b+2)*-c!"))                                   // error
    }
